  ...
  return (
    <div className="flex h-screen justify-center mt-20">
      <div className="glass p-10 border shadow-lg shadow-green-300 w-96 bg-green-100  border-green-200 h-fit rounded-xl">
        <h1 className="text-3xl font-bold mb-5 text-center text-teal-700">Sign In</h1>
        <div className="mb-4">
        ...
        <h4 className='mt-4 text-sm'>dont have account? <span className='underline cursor-pointer' onClick={handleSignUp}>sign-up</span></h4>
      </div>
    </div>
  );
};
